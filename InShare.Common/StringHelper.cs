...
namespace InShare.Common
{
    public class StringHelper
    {
        ...
        /// <returns></returns>
        public static string GetNewStyle(string strList, string newStyle, string splitString, out string strError)
        {
            string returnValue = "";
            //如果输入空值，返回空，并给出错误提示
            ...
            else
            {
                ...
                {
                    returnValue = "";
                    strError = "样式格式的长度与输入的字符长度不符，请重新输入";
                }
                else
                {
                    //检查新样式中分隔符的位置
